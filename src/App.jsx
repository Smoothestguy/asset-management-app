...
function App() {
  ...
  const { assets, portfolioSummary, addAsset, updateAsset, deleteAsset, toggleFavorite } = usePersonalAssets(user)
  ...
  const navigation = [
    { id: 'dashboard', name: 'Dashboard', icon: LayoutDashboard, color: 'cyan' },
  ...
  const getNavColor = (color, isActive) => {
    const colors = {
      cyan: isActive ? 'border-cyan-500 bg-cyan-500/20 text-cyan-400 shadow-[0_0_15px_rgba(0,255,255,0.3)]' : 'text-gray-400 hover:text-cyan-400 hover:bg-cyan-500/10',
      blue: isActive ? 'border-blue-500 bg-blue-500/20 text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.3)]' : 'text-gray-400 hover:text-blue-400 hover:bg-blue-500/10',
      purple: isActive ? 'border-purple-500 bg-purple-500/20 text-purple-400 shadow-[0_0_15px_rgba(139,92,246,0.3)]' : 'text-gray-400 hover:text-purple-400 hover:bg-purple-500/10',
      orange: isActive ? 'border-orange-500 bg-orange-500/20 text-orange-400 shadow-[0_0_15px_rgba(255,107,53,0.3)]' : 'text-gray-400 hover:text-orange-400 hover:bg-orange-500/10',
      pink: isActive ? 'border-pink-500 bg-pink-500/20 text-pink-400 shadow-[0_0_15px_rgba(236,72,153,0.3)]' : 'text-gray-400 hover:text-pink-400 hover:bg-pink-500/10',
      green: isActive ? 'border-green-500 bg-green-500/20 text-green-400 shadow-[0_0_15px_rgba(16,185,129,0.3)]' : 'text-gray-400 hover:text-green-400 hover:bg-green-500/10'
    }
    ...
    >
      ...
      <div className="p-6 border-b border-gray-700/50">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white neon-cyan">ASSET TRACKER</h1>
        ...
        {navigation.map((item, index) => {
          ...
          return (
            <motion.button
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 border ${getNavColor(item.color, isActive)}`}
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className={`text-sm font-semibold ${
                  portfolioSummary.totalGainLoss >= 0 ? 'text-green-400' : 'text-red-400'
                }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredAssets.map((asset, index) => {
            ...
            return (
              ...
              >
                <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-2 hover:border-opacity-80 transition-all duration-300 backdrop-blur-sm overflow-hidden relative modern-border modern-card-enhanced"
