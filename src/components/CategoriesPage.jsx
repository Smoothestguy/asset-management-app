...
const CategoriesPage = () => {
  ...
  const categoryStats = Object.values(ASSET_CATEGORIES).map(category => {
    ...
    const totalCost = categoryAssets.reduce((sum, asset) => sum + asset.purchasePrice, 0)
  ...
  const CategoryCard = ({ category, index }) => (
    ...
    >
      <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-2 hover:border-opacity-80 transition-all duration-300 backdrop-blur-sm overflow-hidden relative"
        ...
        <CardContent className="p-6 relative z-10">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">{category.assetCount} assets</p>
              </div>
            </div>
            ...
            >
              ...
              {category.gainLossPercent > 0 ? '+' : ''}{category.gainLossPercent.toFixed(1)}%
            </Badge>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center space-x-2 text-sm">
              <span className="text-gray-400">Cost: {formatCurrency(category.totalCost)}</span>
          ...
          <div className="mb-4">
            ...
            <div className="w-full bg-gray-700 rounded-full h-2 overflow-hidden">
              <motion.div
                ...
                style={{ 
                  width: `${Math.min(Math.abs(category.gainLossPercent), 100)}%`,
                  boxShadow: `0 0 10px ${category.performance === 'gain' ? '#10b981' : '#ef4444'}60`
                }}
                initial={{ width: 0 }}
                animate={{ width: `${Math.min(Math.abs(category.gainLossPercent), 100)}%` }}
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="bg-gray-800/50 rounded-lg p-2 border border-gray-700/50">
              ...
              <div className="text-white font-semibold">
                {category.assetCount > 0 ? formatCurrency(category.totalValue / category.assetCount) : '$0'}
              </div>
            </div>
            <div className="bg-gray-800/50 rounded-lg p-2 border border-gray-700/50">
              <div className="text-gray-400">Portfolio %</div>
              <div className="text-white font-semibold">
                {portfolioSummary.totalValue > 0 ? ((category.totalValue / portfolioSummary.totalValue) * 100).toFixed(1) : 0}%
              </div>
            </div>
          </div>
        </CardContent>
      ...
      >
        <Card className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border-cyan-500/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-cyan-400 text-sm font-medium">Total Categories</p>
        ...
        <Card className="bg-gradient-to-br from-purple-500/20 to-violet-500/20 border-purple-500/30">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-400 text-sm font-medium">Best Performer</p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-700">
                    ...
                    <th className="text-right py-3 px-4 text-gray-400 font-medium">Assets</th>
                ...
                <tbody>
                  {categoryStats.map((category, index) => (
                    ...
                    >
                      ...
                      <td className="text-right py-4 px-4 text-gray-300">{category.assetCount}</td>
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="p-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg shadow-[0_0_20px_rgba(139,92,246,0.5)]">
              <Grid3X3 className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-white">CATEGORIES</h1>
              <p className="text-gray-400">Manage and analyze your asset categories</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex bg-gray-800 rounded-lg p-1">
              <Button
                ...
                className={viewMode === 'grid' ? 'bg-cyan-500 text-white' : 'text-gray-400'}
              >
              ...
              <Button
                ...
                className={viewMode === 'stats' ? 'bg-cyan-500 text-white' : 'text-gray-400'}
              >
