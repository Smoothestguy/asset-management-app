...
const SettingsPage = () => {
  ...
  return (
    <div
      className={`space-y-8 settings-page ${
        isMobile ? "settings-mobile-container" : ""
      }`}
    >
      {/* Header */}
      <motion.div
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {tabs.map((tab, index) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 border ${getTabColor(
                  tab.color,
                  isActive
                )}`}
        ...
        <motion.div
          ...
          className={`lg:col-span-3 ${
            isMobile ? "settings-mobile-content" : ""
          }`}
        >
          <Card
            className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 backdrop-blur-sm ${
              isMobile ? "settings-content-card" : ""
            }`}
          >
            <CardHeader>
            ...
            <CardContent className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg border border-gray-700/50">
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">
                          Enable background particle animations
                        </p>
                      </div>
                      <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg border border-gray-700/50">
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">
                          Enable GPU acceleration and advanced effects
                        </p>
                      </div>
              ...
              <div
                ...
                } pt-6 border-t border-gray-700/50 ${
                  isMobile ? "settings-action-buttons" : ""
                }`}
              >
                <Button
                  ...
                  className={`border-gray-600 text-gray-300 hover:bg-gray-700 ${
                    isMobile ? "w-full mobile-touch-target" : ""
                  }`}
                >
